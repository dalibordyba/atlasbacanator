...
@Component
/**
 * = ResponsesCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
public class ResponsesCollectionThymeleafLinkFactory implements MethodLinkFactory<ResponsesCollectionThymeleafController> {
     ...
     */
    @Override
	public Class<ResponsesCollectionThymeleafController> getControllerClass() {
        return ResponsesCollectionThymeleafController.class;
    }
	...
	public UriComponents toUri(String methodName, Object[] parameters, Map<String, Object> pathVariables) {
        ...
        if (methodName.equals(CREATE)) {
            return SpringletsMvcUriComponentsBuilder.fromMethodCall(SpringletsMvcUriComponentsBuilder.on(getControllerClass()).create( 0,null)).buildAndExpand(pathVariables);
        }
